      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 glass-gold rounded-full px-4 py-1.5 mb-4">
            ...
            <span className="text-xs tracking-[0.3em] text-primary uppercase">Nos Collections</span>
          </div>
          <h2 className="font-display text-4xl md:text-5xl">
            Parcourir par <span className="italic text-gradient-gold">Catégorie</span>
          </h2>
        </motion.div>
            ...
            >
              ...
              <div className="relative z-10 p-5 w-full">
                ...
                <span className="inline-flex items-center gap-1 text-xs text-primary group-hover:gap-2 transition-all">
                  Voir maintenant <ArrowRight className="w-3 h-3" />
                </span>
              </div>
            </motion.a>
          ))}
