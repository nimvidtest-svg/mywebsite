    ...
    <section id="commander" className="relative py-24 md:py-32">
      <div className="container mx-auto px-6 max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Remplissez le formulaire et commandez via WhatsApp en un clic.</p>
        </motion.div>

        <motion.form onSubmit={submit} noValidate initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          className="glass gold-border rounded-3xl p-8 md:p-10 space-y-5">
