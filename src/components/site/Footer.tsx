        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-3"><MessageCircle className="w-4 h-4 text-primary flex-shrink-0"/>07 03 83 96 18</li>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              {[
                { Icon: MessageCircle, href: "https://wa.me/212703839618" },
