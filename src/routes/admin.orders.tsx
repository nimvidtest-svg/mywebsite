              ...
              <div key={o.id} className={`glass rounded-2xl p-5 border-2 transition-colors duration-300 ${cfg.border}`}>
                ...
                <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
                  ...
                  <div className="flex items-center gap-3">
                    {o.total != null && (
                      <span className="font-display text-xl text-gradient-gold">{o.total} DH</span>
                    )}
                    <button
                      onClick={() => remove(o.id)}
                      className="w-8 h-8 rounded-full glass flex items-center justify-center hover:text-destructive transition"
                    >
